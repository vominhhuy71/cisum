<template>
  <div class="sign-in__hero-section">
    <main-logo />
    <p class="sign-in__header">Sign in</p>
    ...
    <div>
      <button class="sign-in__btn" @click="signInWithEmailPassword">
        Sign in
      </button>
    </div>
    ...
    <div class="sign-in__social-logins" @click="signInWithGoogle">
      <div class="sign-in__social-logins__icon">
        <svg
          height="30px"
          id="Layer_1"
...
export default class extends Vue {
  ...
  private signInWithEmailPassword() {
    console.log('Hi!');
  }
